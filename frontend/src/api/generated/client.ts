...
import type {
  ...
  GetMissingVectorChunksAuditDocumentsAuditMissingVectorChunksGetParams,
 ...
 * @summary Get Missing Vector Chunks Audit
 */
export type getMissingVectorChunksAuditDocumentsAuditMissingVectorChunksGetResponse200 = {
  data: MissingVectorChunkAuditResponse
  status: 200
}

export type getMissingVectorChunksAuditDocumentsAuditMissingVectorChunksGetResponse422 = {
  data: HTTPValidationError
  status: 422
}
    
export type getMissingVectorChunksAuditDocumentsAuditMissingVectorChunksGetResponseSuccess = (getMissingVectorChunksAuditDocumentsAuditMissingVectorChunksGetResponse200) & {
  headers: Headers;
};
export type getMissingVectorChunksAuditDocumentsAuditMissingVectorChunksGetResponseError = (getMissingVectorChunksAuditDocumentsAuditMissingVectorChunksGetResponse422) & {
  headers: Headers;
};

export type getMissingVectorChunksAuditDocumentsAuditMissingVectorChunksGetResponse = (getMissingVectorChunksAuditDocumentsAuditMissingVectorChunksGetResponseSuccess | getMissingVectorChunksAuditDocumentsAuditMissingVectorChunksGetResponseError)

export const getGetMissingVectorChunksAuditDocumentsAuditMissingVectorChunksGetUrl = (params?: GetMissingVectorChunksAuditDocumentsAuditMissingVectorChunksGetParams,) => {
  const normalizedParams = new URLSearchParams();
  ...
  return stringifiedParams.length > 0 ? `/api/documents/audit/missing-vector-chunks?${stringifiedParams}` : `/api/documents/audit/missing-vector-chunks`
}

export const getMissingVectorChunksAuditDocumentsAuditMissingVectorChunksGet = async (params?: GetMissingVectorChunksAuditDocumentsAuditMissingVectorChunksGetParams, options?: RequestInit): Promise<getMissingVectorChunksAuditDocumentsAuditMissingVectorChunksGetResponse> => {
  
  const res = await fetch(getGetMissingVectorChunksAuditDocumentsAuditMissingVectorChunksGetUrl(params),
  {      
    ...options,
    method: 'GET'
  ...
  const data: getMissingVectorChunksAuditDocumentsAuditMissingVectorChunksGetResponse['data'] = body ? JSON.parse(body) : {}
  return { data, status: res.status, headers: res.headers } as getMissingVectorChunksAuditDocumentsAuditMissingVectorChunksGetResponse
}
 ...
 * @summary Metrics
 */
export type metricsStatusMetricsGetResponse200 = {
  data: MetricsStatusMetricsGet200
  status: 200
}
    
export type metricsStatusMetricsGetResponseSuccess = (metricsStatusMetricsGetResponse200) & {
  headers: Headers;
};
;

export type metricsStatusMetricsGetResponse = (metricsStatusMetricsGetResponseSuccess)

export const getMetricsStatusMetricsGetUrl = () => {


  

  return `/api/status/metrics`
}

export const metricsStatusMetricsGet = async ( options?: RequestInit): Promise<metricsStatusMetricsGetResponse> => {
  
  const res = await fetch(getMetricsStatusMetricsGetUrl(),
  {      
    ...options,
    method: 'GET'
  ...
  const data: metricsStatusMetricsGetResponse['data'] = body ? JSON.parse(body) : {}
  return { data, status: res.status, headers: res.headers } as metricsStatusMetricsGetResponse
}
 ...
 */
export type getModelProvidersSettingsModelProvidersGetResponse200 = {
  data: ModelProviderSettingsResponse
  status: 200
}
    
export type getModelProvidersSettingsModelProvidersGetResponseSuccess = (getModelProvidersSettingsModelProvidersGetResponse200) & {
  headers: Headers;
};
;

export type getModelProvidersSettingsModelProvidersGetResponse = (getModelProvidersSettingsModelProvidersGetResponseSuccess)

export const getGetModelProvidersSettingsModelProvidersGetUrl = () => {


  

  return `/api/settings/model-providers`
}

export const getModelProvidersSettingsModelProvidersGet = async ( options?: RequestInit): Promise<getModelProvidersSettingsModelProvidersGetResponse> => {
  
  const res = await fetch(getGetModelProvidersSettingsModelProvidersGetUrl(),
  {      
    ...options,
    method: 'GET'
  ...
  const data: getModelProvidersSettingsModelProvidersGetResponse['data'] = body ? JSON.parse(body) : {}
  return { data, status: res.status, headers: res.headers } as getModelProvidersSettingsModelProvidersGetResponse
}



/**
 * @summary Update Model Providers
 */
export type updateModelProvidersSettingsModelProvidersPutResponse200 = {
  data: ModelProviderSettingsResponse
  status: 200
}

export type updateModelProvidersSettingsModelProvidersPutResponse422 = {
  data: HTTPValidationError
  status: 422
}
    
export type updateModelProvidersSettingsModelProvidersPutResponseSuccess = (updateModelProvidersSettingsModelProvidersPutResponse200) & {
  headers: Headers;
};
export type updateModelProvidersSettingsModelProvidersPutResponseError = (updateModelProvidersSettingsModelProvidersPutResponse422) & {
  headers: Headers;
};

export type updateModelProvidersSettingsModelProvidersPutResponse = (updateModelProvidersSettingsModelProvidersPutResponseSuccess | updateModelProvidersSettingsModelProvidersPutResponseError)

export const getUpdateModelProvidersSettingsModelProvidersPutUrl = () => {
...
export const updateModelProvidersSettingsModelProvidersPut = async (modelProviderSettingsUpdateRequest: ModelProviderSettingsUpdateRequest, options?: RequestInit): Promise<updateModelProvidersSettingsModelProvidersPutResponse> => {
  
  const res = await fetch(getUpdateModelProvidersSettingsModelProvidersPutUrl(),
  {      
    ...options,
    method: 'PUT',
    headers: { 'Content-Type': 'application/json', ...options?.headers },
  ...
  const data: updateModelProvidersSettingsModelProvidersPutResponse['data'] = body ? JSON.parse(body) : {}
  return { data, status: res.status, headers: res.headers } as updateModelProvidersSettingsModelProvidersPutResponse
}



/**
 * @summary Discover Model Providers
 */
export type discoverModelProvidersSettingsModelProvidersDiscoverPostResponse200 = {
  data: ModelProviderDiscoveryResponse
  status: 200
}

export type discoverModelProvidersSettingsModelProvidersDiscoverPostResponse422 = {
  data: HTTPValidationError
  status: 422
}
    
export type discoverModelProvidersSettingsModelProvidersDiscoverPostResponseSuccess = (discoverModelProvidersSettingsModelProvidersDiscoverPostResponse200) & {
  headers: Headers;
};
export type discoverModelProvidersSettingsModelProvidersDiscoverPostResponseError = (discoverModelProvidersSettingsModelProvidersDiscoverPostResponse422) & {
  headers: Headers;
};

export type discoverModelProvidersSettingsModelProvidersDiscoverPostResponse = (discoverModelProvidersSettingsModelProvidersDiscoverPostResponseSuccess | discoverModelProvidersSettingsModelProvidersDiscoverPostResponseError)

export const getDiscoverModelProvidersSettingsModelProvidersDiscoverPostUrl = () => {


  

  return `/api/settings/model-providers/discover`
}

export const discoverModelProvidersSettingsModelProvidersDiscoverPost = async (modelProviderDiscoveryRequest: ModelProviderDiscoveryRequest, options?: RequestInit): Promise<discoverModelProvidersSettingsModelProvidersDiscoverPostResponse> => {
  
  const res = await fetch(getDiscoverModelProvidersSettingsModelProvidersDiscoverPostUrl(),
  {      
    ...options,
    method: 'POST',
    headers: { 'Content-Type': 'application/json', ...options?.headers },
  ...
  const data: discoverModelProvidersSettingsModelProvidersDiscoverPostResponse['data'] = body ? JSON.parse(body) : {}
  return { data, status: res.status, headers: res.headers } as discoverModelProvidersSettingsModelProvidersDiscoverPostResponse
}
