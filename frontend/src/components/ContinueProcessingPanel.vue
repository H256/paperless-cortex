<template>
  ...
  >
      ...
      <ContinueProcessingDiagnosticsSection
        ...
        :show-detailed-counters="showDetailedCounters"
        :show-only-non-zero-counters="showOnlyNonZeroCounters"
        :visible-detailed-counters="visibleDetailedCounters"
        :preview-docs="previewDocs"
        :prioritized-preview-docs="prioritizedPreviewDocs"
        :high-priority-preview-count="highPriorityPreviewCount"
        :execution-plan-steps="executionPlanSteps"
        :execution-scope-items="executionScopeItems"
        :queue-enabled="queueEnabled"
        :queue-length-label="queueLengthLabel"
        :processing-active="processingActive"
        @toggle-detailed-counters="toggleDetailedCounters"
        @update:show-only-non-zero="showOnlyNonZeroCounters = $event"
