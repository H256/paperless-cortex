...
### Backend performance
- `pending` chore(api): regenerated OpenAPI spec + Orval client/models after recent backend route additions (`writebackJobDeleteResponse` now in generated frontend models), then revalidated with frontend type-check and backend compileall.
