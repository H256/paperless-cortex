...
### Backend performance
- `pending` refactor(frontend/writeback): replaced custom HTTP delete call with generated OpenAPI client (`deleteWritebackJobWritebackJobsJobIdDelete`) in `services/writeback.ts`, keeping writeback API access fully contract-driven.
