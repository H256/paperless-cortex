...
### Backend performance
- `pending` ux(documents): enabled Vue Query `keepPreviousData` for the documents list query to avoid table/card flicker while changing pagination and filters.
