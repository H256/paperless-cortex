...
### Backend performance
- `pending` refactor(frontend/queue-types): replaced manual `QueueErrorTypeDetail` shape with alias to generated OpenAPI type `ErrorTypeDetail` to reduce duplicate type maintenance.
